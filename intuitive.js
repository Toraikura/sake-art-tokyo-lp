...
(function () {
  ...
  function renderPlaygroundArcade() {
    ...
    if (!document.getElementById('fpg-preview-styles')) {
      ...
      previewStyles.href = '/fpg-preview.css?v=20260920-shared1';
    ...
    arcade.innerHTML = `
      <div class="wrap fpg-arcade-shell">
        ...
        <div class="fpg-game-grid" aria-label="${english ? 'Fermentation Playground games' : 'FERMENTATION PLAYGROUNDのゲーム'}">
          ...
          <a class="fpg-game fpg-game--live fpg-game--shubo fpg-game--catalog" data-shared-experience="shubo-dive" href="https://toraikura.github.io/shubo-dive/" data-event="sat_to_fpg" data-experience="shubo-dive" data-source-page="${sourcePage}" aria-label="${english ? 'Play SHUBO DIVE' : 'SHUBO DIVEを遊ぶ'}">
            <span class="fpg-game-index">05</span>
            <strong class="fpg-game-title"><span>SHUBO</span><span>DIVE</span></strong>
            <span class="fpg-preview fpg-preview--shubo fpg-preview--catalog" style="--catalog-preview:url('https://toraikura.github.io/sat-fermentation-playground/assets/shared-experiences/shubo-dive.webp');--catalog-position:center 18%" aria-hidden="true"></span>
            <span class="fpg-game-status">${copy.play} <span aria-hidden="true">↗</span></span>
          </a>
          <a class="fpg-game fpg-game--live fpg-game--shubo-world fpg-game--catalog" data-shared-experience="shubo-world" href="https://toraikura.github.io/shubo-world/" data-event="sat_to_fpg" data-experience="shubo-world" data-source-page="${sourcePage}" aria-label="${english ? 'Play SHUBO' : 'SHUBOを遊ぶ'}">
            <span class="fpg-game-index">06</span>
            <strong class="fpg-game-title"><span>SHUBO</span></strong>
            <span class="fpg-preview fpg-preview--shubo-world fpg-preview--catalog" style="--catalog-preview:url('https://toraikura.github.io/sat-fermentation-playground/assets/shared-experiences/shubo-world.webp');--catalog-position:center 42%" aria-hidden="true"></span>
            <span class="fpg-game-status">${copy.play} <span aria-hidden="true">↗</span></span>
          </a>
